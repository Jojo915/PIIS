...
class TestToChunk(unittest.TestCase):
    ...
    def test_chunk_contains_required_keys(self):
        ...
        chunk = cell_factory(MARKDOWN_CELL, cell_index=0).to_chunk(notebook_id="nb_001")
    ...
    def test_chunk_does_not_contain_output(self):
        ...
        chunk = cell_factory(CODE_CELL_WITH_OUTPUT, cell_index=0).to_chunk(
            notebook_id="nb_001"
        )
...
class TestToEmbed(unittest.TestCase):
    ...
    def test_markdown_embed_equals_source(self):
        ...
        cell = cell_factory(MARKDOWN_CELL, cell_index=0)
    ...
    def test_code_embed_contains_source(self):
        ...
        cell = cell_factory(CODE_CELL_WITH_OUTPUT, cell_index=0)
    ...
    def test_code_embed_contains_error_traceback(self):
        ...
        cell = cell_factory(CODE_CELL_WITH_ERROR, cell_index=0)
    ...
    def test_code_embed_without_output_equals_source(self):
        ...
        cell = cell_factory(CODE_CELL_NO_OUTPUT, cell_index=0)
...
class TestOutputParsing(unittest.TestCase):
    ...
    def test_execute_result_is_parsed(self):
        ...
        cell = cell_factory(CODE_CELL_WITH_EXECUTE_RESULT, cell_index=0)
        if cell.output:
    ...
    def test_multiple_outputs_are_concatenated(self):
        ...
        cell = cell_factory(CODE_CELL_MULTIPLE_OUTPUTS, cell_index=0)
        if cell.output:
